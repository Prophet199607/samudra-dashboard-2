    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-2 sm:p-4">
            ...
            <div className="flex items-center space-x-4 text-sm text-gray-600">
              ...
              <div className="flex items-center space-x-1">
                ...
                <span>
                  Remaining:{" "}
                  {TAB_CONFIG.length -
                    TAB_CONFIG.filter((tab) => savedSteps.has(tab.id)).length}
                </span>
              </div>
            </div>
      ...
      {showRejectModal && (
        <ConfirmationModal
          ...
          message="Are you sure you want to reject this payment? This will revert the collection status and remove the payment receipt."
